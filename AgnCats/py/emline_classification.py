...
def Classify_HeII_BPT(table):
    ...
    SNR_Ha = table['HALPHA_FLUX']*np.sqrt(table['HALPHA_FLUX_IVAR'])
    SNR_Hb = table['HBETA_FLUX']*np.sqrt(table['HBETA_FLUX_IVAR'])
    SNR_OIII = table['HEII_4685_FLUX']*np.sqrt(table['HEII_4685_FLUX_IVAR'])
    SNR_NII = table['NII_6584_FLUX']*np.sqrt(table['NII_6584_FLUX_IVAR'])
    
    zero_fluxes = (table['HALPHA_FLUX'] == 0) | (table['HBETA_FLUX'] == 0) | (table['HEII_4685_FLUX']  == 0) |(table['NII_6584_FLUX'] == 0) | fastspec_mask
    ...
    j_bptheii = np.log10(input['HEII_4685_FLUX']/input['HBETA_FLUX'])
